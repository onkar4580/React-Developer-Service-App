  ...
  return (
    <>
      <div className="home" id="home">
        <main>
          <h1>ReactDev</h1>
          <p>Solution to all your frontend side</p>
        </main>
      </div>
      ...
      <div className="home2">
        ...
        <div>
          <p>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi totam explicabo vitae animi maxime assumenda provident nobis commodi ducimus voluptatum!
          </p>
        </div>
      </div>
